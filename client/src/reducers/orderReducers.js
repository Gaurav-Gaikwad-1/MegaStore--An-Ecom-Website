import { ORDER_CREATE_FAIL, ORDER_CREATE_REQUEST, ORDER_CREATE_SUCCESS, 
         ...
         ORDER_PAY_FAIL, ORDER_PAY_REQUEST, ORDER_PAY_SUCCESS,ORDER_PAY_RESET, MY_ORDER_LIST_REQUEST, MY_ORDER_LIST_SUCCESS, MY_ORDER_LIST_FAIL, MY_ORDER_LIST_RESET } from "../constants/orderConstants";
...
export const orderPayReducer = (state={ orderItems:[] , loading:true, shippingAddress:{} } , action) => {
    switch(action.type){
